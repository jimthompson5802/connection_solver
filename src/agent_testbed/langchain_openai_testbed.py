...
# system_message = SystemMessage("You are a helpful assistant who know a lot about fairy tales.")
# human_message = HumanMessage("Tell the story of Little Red Riding Hood in the context of India.")
...
Invalid group of words:
center, guard, quaterback, defense
democrat, defense, discovery, nickelodeon

word list: democrat, oxygen, history, defense, discovery, drive, nickelodeon, dimensional
"""
)
